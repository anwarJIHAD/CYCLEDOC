...
<head>
	...
	<link rel="stylesheet"
		href="<?= base_url('assets/template/') ?>assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
	<link rel="stylesheet" href="<?= base_url('assets/template/') ?>assets/vendor/libs/typeahead-js/typeahead.css" />
	<!-- <link rel="stylesheet" href="<?= base_url('assets/template/') ?>assets/vendor/libs/dropzone/dropzone.css" />	 -->
			...
			<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
				<div class="app-brand demo">
					<a href="index.html" class="app-brand-link">
						...
						<span class="app-brand-text demo menu-text fw-bold ms-2">SycleDoc</span>
					</a>
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item">
						<a href="<?= base_url('C_Visual') ?>" class="menu-link">
							<i class="menu-icon tf-icons bx bxs-universal-access"></i>
							<div class="text-truncate" data-i18n="Personal Visualitation">Personal Visualitation</div>
						</a>
					</li>
					<li class="menu-item">
						<a href="<?= base_url('C_unit') ?>" class="menu-link">
							<i class="menu-icon tf-icons bx bxs-customize"></i>
							<div class="text-truncate" data-i18n="Unit Tools">Unit Tools</div>
						</a>
					</li>
					<!-- <li class="menu-item">
						<a href="C_Unit" class="menu-link">
							<i class="menu-icon tf-icons bx bxs-customize"></i>
							<div class="text-truncate" data-i18n="Unit Tools">Admin</div>
						</a>
					</li> -->
					<li class="menu-item">
