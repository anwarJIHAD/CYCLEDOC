...
<div class="container-xxl flex-grow-1 container-p-y">
	<h4 class="py-1 mb-3"><span class="text-muted fw-light"></span> Unit Alat</h4>



	<!-- Responsive Datatable -->
	<div class="card">
		<h5 class="card-header">Unit Alat</h5>
		<div class="card-header d-flex flex-row justify-content-end gap-3">
			<a href="<?= base_url('C_Unit/tambah') ?>" class="btn btn-primary">
				...
				<div style="font-size:10px;">Tambah Unit Alat</div>
			</a>
